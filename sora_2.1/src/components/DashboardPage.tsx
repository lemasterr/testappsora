...
export const DashboardPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      {/* Hero Section */}
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-indigo-900/40 via-black to-black border border-zinc-800/50 p-10 flex items-center justify-between">
        ...
        <div className="relative z-10 max-w-2xl">
          ...
          <p className="text-zinc-400 text-sm leading-relaxed max-w-lg">
            Advanced automation toolkit for generation, downloading, and post-processing.
            Manage multi-session workflows with precision and ease.
          </p>
        </div>
        {/* Decorative element */}
        <div className="hidden lg:block relative z-10 opacity-80">
            <Icons.Automator className="w-32 h-32 text-indigo-900/40" />
        </div>
      </div>
