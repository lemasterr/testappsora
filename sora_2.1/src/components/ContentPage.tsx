...
import type { ChromeProfile, SessionFiles, ManagedSession } from '../../shared/types';
...
export const ContentPage: React.FC = () => {
  ...
  const getSessionForProfile = (pName: string) => {
      return sessions.find(s => s.chromeProfileName === pName)?.name;
  };
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2 bg-zinc-900 p-1 rounded-lg border border-zinc-800">
            ...
            >
              {profiles.map(p => {
                  const sName = getSessionForProfile(p.name);
                  return (
