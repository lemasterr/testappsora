...
export function Layout({
  ...
  const navItems: NavItem[] = useMemo(
    () => [
      ...
      { key: 'integrations', label: 'Integrations', icon: <Icons.Code className="w-5 h-5" /> }, // Moved up for visibility
      ...
      { key: 'gallery', label: 'Gallery', icon: <Icons.Gallery className="w-5 h-5" /> },
      ...
      { key: 'merge', label: 'Merge', icon: <Icons.Combine className="w-5 h-5" /> },
  ...
  return (
    <div className="relative flex h-screen flex-col text-zinc-100 font-inter overflow-hidden bg-[#020203] selection:bg-indigo-500/30">
      <TitleBar
        title={pageTitle}
      ...
      <div className="flex min-h-0 flex-1 overflow-hidden">
        ...
        />
        <div className="flex min-w-0 flex-1 flex-col overflow-hidden bg-transparent relative">
          <main className="flex-1 overflow-y-auto p-6 animate-fade-in scrollbar-thin relative z-10">
