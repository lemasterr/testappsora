...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  files: {
    ...
    choose: (type: 'file' | 'folder') => safeInvoke('files:choose', type),
    consolidate: () => safeInvoke('files:consolidate'),
  },
  autogen: {
  ...
  logs: {
    ...
    getHistory: () => safeInvoke('logging:getHistory'),
  },
  video: {
    ...
    merge: (inputDir: string, output: string) => safeInvoke('video:merge', inputDir, output),
    blurProfiles: {
  ...
  inspector: {
    start: (sessionId: string) => safeInvoke('inspector:start', sessionId),
    poll: (sessionId: string) => safeInvoke('inspector:poll', sessionId),
  },
  gallery: {
    scan: () => safeInvoke('gallery:scan'),
    delete: (path: string) => safeInvoke('gallery:delete', path)
  },
