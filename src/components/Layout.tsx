...
export function Layout({
  ...
  const navItems: NavItem[] = useMemo(
    () => [
      ...
      { key: 'integrations', label: 'Integrations', icon: <Icons.Code className="w-5 h-5" /> }, // Ensure this is here
  ...
  return (
    <div className="relative flex h-screen flex-col text-zinc-100 font-inter overflow-hidden">
      <TitleBar
        title={pageTitle}
